...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($end_date) {
        ...
        $query = "INSERT into advise_undergraduate(instructor_id, student_id, start_date, end_date) values ('$instructor_id', '$student_id', '$start_date', '$end_date')";
    } else {
        $query = "INSERT into advise_undergraduate(instructor_id, student_id, start_date) values ('$instructor_id', '$student_id', '$start_date')";
    }
